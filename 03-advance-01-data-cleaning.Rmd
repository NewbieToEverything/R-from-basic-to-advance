...
data_idesub_diffvar_01 <- data.frame(
  id = 1:(n_examinee + 10), 
...
data_idesub_diffvar_02 <- data.frame(
  id = 1:n_examinee, 
...
write.table(untidy_data, "data/untidy data virtual imaginary.txt")
```
...
[A more detailed introduction on attention check: Prolific's Attention and Comprehension Check Policy](https://researcher-help.prolific.com/en/article/fb63bb)
...
set.seed(123)
cor_matrix <- matrix(
  c(1, 0.43, 0.28, 0.43, 1, 0.12, 0.28, 0.12, 1), 
  nrow = 3, ncol = 3
)

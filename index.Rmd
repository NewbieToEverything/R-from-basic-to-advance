...
description: "帮助零基础使用者掌握R语言的核心知识点，有效提高基于R语言的编程能力，形成扎实的R代码能力并运用于解决领域特定的问题中去。"
...
本书作为一个整体采用的开源协议为 [Creative Commons Attribution-NonCommercial-ShareAlike 4.0 International License](https://creativecommons.org/licenses/by-nc-sa/4.0/)

书中的所有代码采用[MIT license](https://opensource.org/licenses/MIT).
